...
instance.prototype.setCountDownTimerMode = function(mode, hours, minutes, seconds, tseconds, alarmEnable, alarmDuration) {
	let self = this;
...
instance.prototype.resetCountDownTimer = function(mode, hours, minutes, seconds, tseconds, alarmEnable, alarmDuration) {
	let self = this;
